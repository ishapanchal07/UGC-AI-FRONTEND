                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
                            <div className="abs;oute top-0 right-0 p-4 opacity-10">
                            ...
                            {!project.generatedVideo ? (
                                ...
                                <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-xl text-green-500/20 rounded-xl ">
